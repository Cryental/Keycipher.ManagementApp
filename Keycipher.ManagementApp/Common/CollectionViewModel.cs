...
namespace Keycipher.ManagementApp.Common
{
        ...
        where TUnitOfWork : IUnitOfWork
    {
        ...
        /// </param>
        protected CollectionViewModel(IUnitOfWorkFactory<TUnitOfWork> unitOfWorkFactory,
            ...
            UnitOfWorkPolicy unitOfWorkPolicy = UnitOfWorkPolicy.Individual) : base(unitOfWorkFactory,
        ...
        where TUnitOfWork : IUnitOfWork
    {
        ...
        public static CollectionViewModel<TEntity, TProjection, TPrimaryKey, TUnitOfWork>
            CreateProjectionCollectionViewModel(IUnitOfWorkFactory<TUnitOfWork> unitOfWorkFactory,
                Func<TUnitOfWork, IRepository<TEntity, TPrimaryKey>> getRepositoryFunc,
                Func<IRepositoryQuery<TEntity>, IQueryable<TProjection>> projection,
                Action<TEntity> newEntityInitializer = null,
                Func<bool> canCreateNewEntity = null,

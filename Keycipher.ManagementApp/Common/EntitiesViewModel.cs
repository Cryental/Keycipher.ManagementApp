...
namespace Keycipher.ManagementApp.Common
{
    ...
    ///     This is a partial class that provides an extension point to add custom properties, commands and override methods
    ...
    public abstract class EntitiesViewModel<TEntity, TProjection, TUnitOfWork> :
        ...
        where TUnitOfWork : IUnitOfWork
    {
        ...
        /// </param>
        protected EntitiesViewModel(IUnitOfWorkFactory<TUnitOfWork> unitOfWorkFactory,
